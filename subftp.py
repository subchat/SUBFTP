...
def process_ips(ip_list, output_file, credentials, thread_count=10):
    ...
    for ip in ip_list:
        while len(threads) >= thread_count:
            ...
            time.sleep(0.1)  # Give some time for threads to complete
...
def main():
    ...
    parser.add_argument('-t', '--threads', metavar='N', type=int, default=10, help='Number of concurrent threads')
    ...
    try:
        process_ips(ip_list, output_file, credentials, args.threads)
